...
/*TAMAM*/
session_start();
if (isset($_SESSION["kod"]) == false) // Giriş yapmamışsa
{
...
<html lang="tr">
    ...
    <body id="page-top">
        ...
        <div class="container p-0">
            ...
            <h3> Öğrenci Ekleme</h3>

            <form action="ogrenciekle.php" method="POST">
              <label for="numara">Numara:</label><br>
              ...
              <input type="text" id="sehir" name="sehir"><br><br>
              <label for="telefon">Telefon:</label><br>
              <input type="text" id="telefon" name="telefon"  maxlength="11" placeholder="05********"><br><br>
